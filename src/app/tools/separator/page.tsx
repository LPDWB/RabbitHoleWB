        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="glass flex flex-col gap-4 rounded-2xl p-6">
            ...
            <textarea
              ...
              className="glass glass-field h-80 w-full resize-none rounded-lg px-4 py-3 font-mono text-sm text-foreground outline-none transition focus-visible:ring-2 focus-visible:ring-[color:var(--glass-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-background"
            />
          ...
          <div className="glass flex flex-col gap-4 rounded-2xl p-6">
            ...
            <textarea
              ...
              readOnly
              spellCheck={false}
              className="glass glass-field h-80 w-full resize-none rounded-lg px-4 py-3 font-mono text-sm text-foreground opacity-95 outline-none focus-visible:ring-1 focus-visible:ring-[color:var(--glass-ring)]"
            />
          </div>
        </div>
      </div>
